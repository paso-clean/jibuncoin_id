CREATE TABLE IF NOT EXISTS xsystem_app_registers (
...
CREATE TABLE IF NOT EXISTS xsystem_app_groups (
...
CREATE TABLE IF NOT EXISTS xsystem_app_coins (
...
CREATE TABLE IF NOT EXISTS xsystem_app_servers (
    `user_code` varchar(20) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS xsystem_app_tokens (
